...
Ранг типа массива задается крайнее левое *rank_specifier* в *array_type*: Объект *rank_specifier* указывает, что массив является массивом с рангом 1 + число из "`,`" токены *rank_specifier*.
