...
Назначение `d2` показано, как можно создать делегат для метода, имеющего менее производный (контравариантные) типы параметров и более производный (ковариантным) тип возвращаемого значения.
